...
public class DevBootstrap implements ApplicationListener<ContextRefreshedEvent>{
    ...
    private void initData(){
        ...
        //Publishers
        Publisher harperCollins = new Publisher("Harper Collins", "231 Harper Street");
        Publisher worx = new Publisher("Worx", "8792 South Worx Rd.");
        ...
        Book noEJB = new Book("J2EE Developmentt without EJB", "234444", worx);
